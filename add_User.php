                              ...
                              <div class="page-header ">
                                ...
                                <form method="post" action="admin_profile.php" >
                                  ...
                                  <div class="input-group">
                                    <label class="text-danger"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;Username</label>
                                    <input type="text" name="username" class="text-danger" value="<?php echo $username; ?>" placeholder="Please Enter Your Name.">
                                  </div>
                                  <div class="input-group">
                                    <label class="text-danger"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;Email</label>
                                    <input type="email" name="email" class="text-danger" value="<?php echo $email; ?>" placeholder="Please Enter Your Email Id.">
                                  </div>
                                  <div class="input-group">
                                    <label class="text-danger"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;&nbsp;Password</label>
                                    <input type="password" name="password_1" class="text-danger" placeholder="Please Enter Your Password.">
                                  </div>
                                  <div class="input-group">
                                    <label class="text-danger"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;&nbsp;Confirm Password</label>
                                    <input type="password" name="password_2" class="text-danger" placeholder="Please Enter Your Password Again.">
                                  </div>
                                  <br>

                                  <div class="input-group">
                                    <a href="admin_profile.php" class="btn bg-danger text-light">Cancel</a>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="submit" class="btn bg-success text-white" name="reg_user">Add User</button>
                                  </div>
