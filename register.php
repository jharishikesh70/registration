...
<html lang="en">
  ...
  <body class="body">
    ...
    <div class="header ">
      <h2> Admin Registerations</h2>
    </div>
    <!--Ending Starting Header Section-->
    ...
    <form method="post" action="register.php">
      ...
      <div class="input-group">
        ...
        <input type="text" name="username" style="color:black;" value="<?php echo $username; ?>" placeholder="Please Enter Your Name.">
      </div>
      <div class="input-group">
        <label class="text-light"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;Email</label>
        <input type="email" name="email" style="color:black;" value="<?php echo $email; ?>" placeholder="Please Enter Your Email Id.">
      </div>
      <div class="input-group">
        <label class="text-light"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;&nbsp;Password</label>
        <input type="password" name="password_1" style="color:black;" placeholder="Please Enter Your Password.">
      </div>
      <div class="input-group">
        <label class="text-light"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;&nbsp;Confirm Password</label>
        <input type="password" name="password_2" style="color:black;" placeholder="Please Enter Your Password Again.">
      </div>
      <br>
      <div class="input-group">
        <button type="submit" class="btn bg-success text-white" name="reg_user">Register</button>
        <b class="text-light">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        Already a member?</b>
        &nbsp;&nbsp;<a href="login.php" class="btn bg-primary text-light">Sign in</a>
      </div>
      <br>
    </form>
    <!--Ending Form Section-->
